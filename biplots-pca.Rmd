...
From this data behavior we can conclude that new death and cases are inversely proportional which means that vaccination helps to decrease the spread of the virus.
This information can also be interpreted in another way. As we mentioned in the PCA analysis, the Y axis represents the response measures of the governments.
