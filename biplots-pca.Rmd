...
After these two trimming processes, the pre process of the country data frame is done. To see the behavior of the variables that compose the countries data frame, refer to the Figure \@ref(fig:lotBoxplots).
...
To see the behaviour of the time series data frame, some countries are hand picked to show the behaviour of some variables. These countries corresponds to Russia, Chile, China, the United Stated of America, Germany, Franec, Brazil, Turkey, Italy and South Korea.
