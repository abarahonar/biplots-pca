...
```
Analyzing  the data within each single cluster we did not really notice any specific behavior for each country. Therefor we decided to take the total data for each cluster and compare it with one another. As we see in the (Figure x), in avarage the data of each cluster 
