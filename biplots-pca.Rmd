...
countries.scaled <- scale(subset(countries, select =-c(population)))
...
# }
  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = date, y = total_deaths_per_million, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = date, y = reproduction_rate, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = date, y = total_tests_per_thousand, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = date, y = total_vaccinations_per_hundred, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = date, y = people_vaccinated_per_hundred, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = date, y = people_fully_vaccinated_per_hundred, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = date, y = total_boosters_per_hundred, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = date, y = stringency_index, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)
...
# Total cases on total tests
  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = total_cases_per_million, y = total_tests_per_thousand, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = total_cases_per_million, y = total_deaths_per_million, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)

  countries.subset <- totals.modifies[totals.modifies$iso_code %in% interesting.countries,]
p <- ggplot(data = countries.subset, aes(x = people_fully_vaccinated_per_hundred, y = total_cases_per_million, group = iso_code)) +
  geom_line(aes(color = iso_code)) +
  theme(axis.text.x = element_blank())
print(p)
```
